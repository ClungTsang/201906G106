package com.tsang.tomcat.embTomcat;


import com.tsang.tomcat.servlet.DemoServlet;
...
public class MyTomcat {
    public static void main(String[] args) throws LifecycleException {
        ...
        if(context instanceof StandardContext) {
            ...
            //要给一个默认的web.xml文件
            standardContext.setDefaultContextXml("C:\\Program Files\\tomcat\\apache-tomcat-8.5.41\\conf\\web.xml");
            //把server设置进去
